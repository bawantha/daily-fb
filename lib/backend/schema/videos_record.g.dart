    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'title':
          ...
          break;
        case 'embed':
          result.embed = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String;
          break;
...
class _$VideosRecord extends VideosRecord {
  ...
  _$VideosRecord._({this.title, this.embed, this.reference}) : super._();
  ...
  int get hashCode {
    return $jf(
        $jc($jc($jc(0, title.hashCode), embed.hashCode), reference.hashCode));
  }
...
class VideosRecordBuilder
  ...
  _$VideosRecord build() {
    final _$result = _$v ??
        new _$VideosRecord._(title: title, embed: embed, reference: reference);
    replace(_$result);
    return _$result;
  }
}
